...
class PSMReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        # override rewards
        self.rewards.end_effector_position_tracking.params["asset_cfg"].body_names = ["psm_tool_yaw_link"]
        self.rewards.end_effector_orientation_tracking.params["asset_cfg"].body_names = ["psm_tool_yaw_link"]
        # override actions
